...
const TOPICS: Record<string, HistoryLine[]> = {
  help: [
    ...
    { text: "  contracts    — program addresses", style: "text-white" },
  ...
  what: [
    ...
    { text: "", style: "" },
    {
      text: "plasma is a privacy pool on Solana that breaks the on-chain",
      style: "text-white",
    },
    ...
    {
      text: "via Kamino lending. all of this is verified by zero-knowledge",
      style: "text-white",
    },
    {
      text: "proofs — no trust required. the program enforces everything.",
      style: "text-white",
    },
    { text: "", style: "" },
    {
  ...
  how: [
    ...
    {
      text: "   you commit USDC to the pool. the program stores a",
      style: "text-white",
    },
    {
    ...
    {
      text: "   the program verifies the proof on-chain, checks the",
      style: "text-white",
    },
    {
    ...
    { text: "", style: "" },
    {
      text: "the program never knows which deposit corresponds to",
      style: "text-accent",
    },
  ...
  deposit: [
    ...
    {
      text: "  4. sends USDC + proof to the pool program",
      style: "text-white",
    },
    {
      text: "  5. program verifies proof, takes USDC, inserts commitment",
      style: "text-white",
    },
    ...
    { text: "", style: "" },
    {
      text: "the pool auto-deposits idle USDC into Kamino lending for yield.",
      style: "text-muted",
    },
    { text: "", style: "" },
  ],
  withdraw: [
    ...
    {
      text: "  5. program verifies proof, records nullifier, sends USDC",
      style: "text-white",
    },
    { text: "", style: "" },
    {
  ...
  zk: [
    ...
    { text: "", style: "" },
    {
      text: "the verifier (solana program) can confirm this is true",
      style: "text-white",
    },
    {
    ...
    { text: "verifier: solana program (on-chain, alt_bn128 precompile)", style: "text-muted" },
  ...
  merkle: [
    ...
    {
      text: "leaf. the program stores only the root + a history of",
      style: "text-white",
    },
    {
    ...
    {
      text: "to a known root. the program checks the root exists in",
      style: "text-white",
    },
    ...
    {
      text: "emitted by the program — fully trustless, no indexer.",
      style: "text-muted",
    },
    { text: "", style: "" },
  ],
  yield: [
    ...
    { text: "", style: "" },
    {
      text: "idle USDC in the pool is automatically deployed to Kamino",
      style: "text-white",
    },
    {
      text: "lending via CPI. the pool PDA owns both the USDC vault",
      style: "text-white",
    },
    { text: "and the cToken account:", style: "text-white" },
    { text: "", style: "" },
    {
      text: "  on deposit:    USDC enters pool -> swept to Kamino",
      style: "text-green-500",
    },
    {
      text: "  on withdraw:   Kamino redeems -> USDC sent to recipient",
      style: "text-green-500",
    },
    {
  ...
  fees: [
    ...
    { text: "", style: "" },
    {
      text: "fees will be enabled when the Arcium relayer is added.",
      style: "text-muted",
    },
    {
  ...
  trust: [
    ...
    {
      text: "  - the solana program is correct (auditable, immutable)",
      style: "text-white",
    },
    {
    ...
    {
      text: "  - Solana validators (standard consensus assumptions)",
      style: "text-white",
    },
    { text: "", style: "" },
    {
  ...
  contracts: [
    { text: "", style: "" },
    {
      text: "solana programs (devnet)",
      style: "text-accent font-bold",
    },
    { text: "", style: "" },
    {
      text: "  privacy-yield   5S7PQfffWm4uYMg62Zsjzp2BZgTQSVFj8cmoNBRggwWw",
      style: "text-white",
    },
    {
      text: "  mock-klend      CcubA6KJKRuBV1GBbXxeu9rNwv6UeVLZfCvfs6LqBZfk",
      style: "text-white",
    },
    { text: "", style: "" },
    {
      text: "  RPC:          Solana devnet",
      style: "text-muted",
    },
    { text: "  Explorer:     https://explorer.solana.com", style: "text-muted" },
    { text: "", style: "" },
  ],
  contact: [
    { text: "", style: "" },
    ...
    { text: "", style: "" },
    { text: "  github:       github.com/privacy-yield-protocol", style: "text-white" },
    { text: "", style: "" },
  ],
};
...
function findTopic(input: string): string | null {
  ...
  const keywords: Record<string, string[]> = {
    ...
    yield: ["earn", "interest", "apy", "vault", "return", "kamino"],
    fees: ["fee", "cost", "price", "charge", "gas"],
    trust: ["trust", "security", "safe", "risk", "assumption", "audit"],
    contracts: ["contract", "address", "deployed", "chain", "rpc", "program"],
